...
string ParallelSums(const int *arr, const size_t arr_size)
{
    ...
    const bool is_partial_numbers_size_odd{(arr_size / 2) % 2 == 1};
    ...
    do
    {
        ...
        for (size_t i{}, j{arr_size - 1}; i < j; i++, j--)
        {
            if (is_left_turn)
            {
                ...
                {
                    if (left_sum + numbers[i] > half_sum)
                    {
                        left_sum = 0;
                        break;
                    }
                    ...
                    if (right_sum + numbers[j] > half_sum)
                    {
                        left_sum = 0;
                        break;
                    }
                ...
                {
                    if (left_sum + numbers[i] + numbers[j] > half_sum)
                    {
                        left_sum = 0;
                        break;
                    }
            ...
            else
            {
                ...
                {
                    if (right_sum + numbers[i] + numbers[j] > half_sum)
                    {
                        left_sum = 0;
                        break;
                    }
