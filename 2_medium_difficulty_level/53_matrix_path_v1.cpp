/*
Coderbyte coding challenge: Matrix Path v1
(recursive solution)
...
string MatrixPath_v1(string* str_arr, const size_t str_arr_size) {
...
int main() {
  // string A[] = gets(stdin);
  // cout << MatrixPath_v1(A, sizeof(A)/sizeof(*A));
  string B[] = {"11100", "10011", "10101", "10011"};
  cout << MatrixPath_v1(B, sizeof(B) / sizeof(*B))
       << '\n';  // expected output: 2
  string C[] = {"10000", "11011", "10101", "11001"};
  cout << MatrixPath_v1(C, sizeof(C) / sizeof(*C))
       << '\n';  // expected output: 1
  string D[] = {"1000001", "1001111", "1010101"};
  cout << MatrixPath_v1(D, sizeof(D) / sizeof(*D))
