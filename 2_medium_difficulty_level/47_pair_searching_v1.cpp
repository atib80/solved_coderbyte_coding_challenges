/*
Coderbyte coding challenge: Pair Searching v1
(recursive solution)
...
void find_min_number_of_iterations(const int prev_num,
                                   const int next_num,
  ...
  for (size_t i{}; i < digits.size(); i++) {
    ...
    find_min_number_of_iterations(next_num, temp_num, min_number_of_iterations,
                                  iter + 1);
  }
}

int PairSearching_v1(const int num) {
...
int main() {
  ...
  cout << PairSearching_v1(134) << '\n';  // expected output: 1
  cout << PairSearching_v1(46) << '\n';   // expected output: 2
  cout << PairSearching_v1(8) << '\n';    // expected output: 3
  cout << PairSearching_v1(198) << '\n';  // expected output: 2
