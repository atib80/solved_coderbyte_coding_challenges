...
class ResultBuilder : public DecomposedExpression {
 public:
  ...
  void captureMatch(ArgT const& arg,
...
class ExpressionLhs : public DecomposedExpression {
 public:
  ...
  template <typename RhsT>
  BinaryExpression<T, Internal::IsGreaterThanOrEqualTo, RhsT const&> operator>=(
      RhsT const& rhs) {
...
class BinaryExpression : public DecomposedExpression {
 public:
  ...
  void endExpression() const {
    m_rb.setResultType(
            Internal::Evaluator<LhsT, RhsT, Op>::evaluate(m_lhs, m_rhs))
        .endExpression(*this);
  }
...
template <typename ArgT, typename MatcherT>
void ResultBuilder::captureMatch(ArgT const& arg,
                                 MatcherT const& matcher,
                                 char const* matcherString) {
...
#else
#define CATCH_INTERNAL_STRINGIFY(expr) \
...
#define INTERNAL_CHECK_THAT_NO_TRY(macroName, matcher, resultDisposition, arg) \
  do {                                                                         \
    Catch::ResultBuilder __catchResult(                                        \
        ...
        resultDisposition);                                                    \
    __catchResult.setExceptionGuard();                                         \
    __catchResult.captureMatch(arg, matcher,                                   \
...
#define INTERNAL_CATCH_THROWS(macroName, resultDisposition, matcher, expr)  \
  do {                                                                      \
    Catch::ResultBuilder __catchResult(                                     \
        macroName, CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(expr), \
...
class Parser {
 ...
 public:
  ...
  Mode handlePositional(std::size_t i,
                        char c,
                        std::string const& arg,
                        std::vector<Token>& tokens) {
...
inline void setWaitForKeypress(ConfigData& config,
...
class RunContext : public IResultCapture, public IRunner {
 ...
 private:  // IResultCapture
  ...
  virtual void assertionRun() { m_prevPassed = m_totals.assertions.passed; }
...
inline TestCase::TestCase(ITestCase* testCase, TestCaseInfo const& info)
...
std::string getFormattedDuration(const double duration) {
