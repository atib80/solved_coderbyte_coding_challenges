...
Using the C++ language, have the function ThirdGreatest(strArr) take the array of strings stored in strArr and return the third largest word within in. 
...
string ThirdGreatest(vector<string> words) {
  ...
  if (words.size() < 3u) return string{"Not possible!"};
