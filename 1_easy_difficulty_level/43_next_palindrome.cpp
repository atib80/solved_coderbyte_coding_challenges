...
Using the C++ language, have the function NextPalindrome(num) take the num parameter being passed and return the next largest palindromic number. 
...
bool is_next_number_palindrome(const string& num_str) {
	...
	if (num_str == reversed_num_str) return true;
